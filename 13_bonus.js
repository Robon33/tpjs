 ...
 *
 * Objectif :
 * Écrire une fonction qui prend en entrée une chaîne de caractères et qui retourne un objet
 * où les clés sont les mots de la phrase et les valeurs sont le nombre de fois où ces mots apparaissent.
 *
 * Consignes :
 ...
 *
 * Objectif :
 * Écrire une fonction qui prend en entrée un objet et qui retourne un nouvel objet dont les propriétés
 * sont triées en fonction de leurs valeurs, en ordre croissant.
 *
 * exemple:
 * {
 *   "pommes": 3,
